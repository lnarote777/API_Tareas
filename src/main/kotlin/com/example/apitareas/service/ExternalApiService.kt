...
import com.example.apitareas.domain.DatosMunicipios
import com.example.apitareas.domain.DatosProvincias
...
class ExternalApiService(private val webClient: WebClient.Builder) {
    ...
    fun obtenerDatosMunicipios(provincia: String): DatosMunicipios? {
        return webClient.build()
            .get()
            .uri("https://apiv1.geoapi.es/municipios?CPRO=$provincia&type=JSON&key=$apiKey")
            .retrieve()
